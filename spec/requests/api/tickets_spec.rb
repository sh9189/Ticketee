...
RSpec.describe "Tickets API" do
  ...
  let(:ticket) do
    FactoryGirl.create(:ticket, project: project, state: state, author: user)
  end
  ...
  context "as an authenticated user" do
    ...
    it "retrieves a ticket's information" do
      ...
      json = ActiveModelSerializers::SerializableResource.new(ticket).to_json
    ...
    it "can create a ticket" do
      ...
      json = ActiveModelSerializers::SerializableResource.new(Ticket.last).to_json
      expect(response.body).to eq json
    end
